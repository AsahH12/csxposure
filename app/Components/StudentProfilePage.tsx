    ...
    const fetchUserData = async () => {
      try {
        ...
        if (userDocSnap.exists()) {
          ...
          // ✅ Fix for status issue: Ensure status is always an array
          setStatus(Array.isArray(userData?.status) ? userData.status : [userData?.status || "Student"]);
        } else {
        ...
        <div className="student-profile-card">
          ...
          <div className="profile-form">
            <div className="profile-picture">
              {profileImage ? <img src={profileImage} alt="Profile" /> : <div className="placeholder-image"></div>}
            </div>
            ...
            <div className="form-group">
              <label>Status:</label>
              <div className="input-field">{status.join(", ")}</div>
            </div>
